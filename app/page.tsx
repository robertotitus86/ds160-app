...
export default function HomePage() {
  ...
  function addItem(id: PlanId) {
    // evita duplicados (puedes permitirlos si quieres)
  ...
  function goCheckout() {
    // El checkout ya lee ds160_cart, pero pasamos también por URL para compartir carrito
  ...
  function buyNow(id: PlanId) {
    // Si no hay nada en el carrito, lleva solo ese. Si hay, usa todo el carrito.
  ...
  return (
    <div style={{ display: 'grid', gap: 16 }}>
      ...
      {/* Planes con “Agregar” y “Comprar rápido” */}
      <section style={card}>
