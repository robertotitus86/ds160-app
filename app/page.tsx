  ...
  return (
    <main style={{display:"grid", gap:16, gridTemplateColumns:"repeat(auto-fit,minmax(260px,1fr))"}}>
      <section className="card">
        ...
        <p><b>$45 USD</b></p>
        <a href="/checkout?plan=llenado" className="btn">Seleccionar</a>
      </section>
      <section className="card">
        ...
        <p><b>$35 USD</b></p>
        <a href="/checkout?plan=asesoria" className="btn">Seleccionar</a>
      </section>
      <section className="card">
        ...
        <p><b>$15 USD</b></p>
        <a href="/checkout?plan=cita" className="btn">Seleccionar</a>
      </section>
    </main>
  );
}
